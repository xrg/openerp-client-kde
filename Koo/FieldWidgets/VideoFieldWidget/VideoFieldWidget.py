...
(VideoFormWidgetUi, VideoFormWidgetBase) = loadUiType( Common.uiPath('video.ui') ) 

class VideoFormWidget(AbstractFormWidget, VideoFormWidgetUi):
	def __init__(self, parent, view, attrs={}):
		AbstractFormWidget.__init__(self, parent, view, attrs)
		VideoFormWidgetUi.__init__(self)
		self.setupUi(self)
