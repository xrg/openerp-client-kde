...
class CustomSearchItemWidget(AbstractSearchWidget, CustomSearchItemWidgetUi):
	...
	operators = (
		('is empty', _('is empty'), ('selection', 'char', 'text', 'many2one', 'many2many', 'date', 'time', 'datetime', 'float_time', 'binary'), False),
		('is not empty', _('is not empty'), ('selection', 'char', 'text', 'many2one', 'many2many', 'date', 'time', 'datetime', 'float_time', 'binary'), False),
